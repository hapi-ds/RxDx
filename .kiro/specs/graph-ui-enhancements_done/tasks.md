...
- [x] 7. Implement isolation mode state management
  - [x] 7.1 Add isolation mode state to graphStore
  ...
  - [x] 7.2 Implement calculateNeighbors helper function
  ...
  - [x] 7.3 Implement isolation mode actions
  ...
  - [x] 7.4 Write property test for isolation visibility
    - **Property 10: Isolation visibility correctness**
    - **Validates: Requirements 3.1, 3.2**
  
  - [x] 7.5 Write property test for isolated edge validity
    - **Property 11: Isolated edge validity**
    - **Validates: Requirements 3.3**
  
  - [x] 7.6 Write property test for isolation mode transitions
    - **Property 12: Isolation mode transitions**
    - **Validates: Requirements 3.4**
  
  - [x] 7.7 Write property test for isolation depth responsiveness
    - **Property 13: Isolation depth responsiveness**
    - **Validates: Requirements 3.8**

- [x] 8. Create IsolationIndicator component
  - [x] 8.1 Implement IsolationIndicator component
  ...
  - [x] 8.2 Write property test for isolation indicator content
    - **Property 14: Isolation indicator content**
    - **Validates: Requirements 3.7**
  
  - [x] 8.3 Integrate IsolationIndicator into GraphExplorer
    - Add component above graph view
    - Show only when isIsolationMode is true
    - Connect to graphStore isolation state
    - _Requirements: 3.6_

- [x] 9. Implement Shift-click isolation in GraphView2D
  - [x] 9.1 Add Shift-click handler to node interactions
  ...
  - [x] 9.2 Filter visible nodes and edges based on isolation state
  ...
  - [x] 9.3 Add Escape key and background click handlers
    - Listen for Escape key press
    - Listen for background click events
    - Call exitIsolationMode on either event
    - _Requirements: 3.5_
  
  - [x] 9.4 Connect depth control to isolation mode
...
- [x] 10. Checkpoint - Isolation mode feature complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Simplify NodeTypeFilter labels
  - [x] 11.1 Remove color text from type labels
...
- [x] 12. Final integration and testing
  - [x] 12.1 Integration test: Distance control workflow
    - Load GraphExplorer
  ...
  - [x] 12.2 Integration test: Enhanced search workflow
    - Load graph with mixed node types
    - Search by ID
    - Search by title
    - Verify all node types are searchable
  
  - [x] 12.3 Integration test: Isolation mode workflow
    - Load graph
    - Shift-click node
    - Verify isolation
    - Change depth
  ...
  - [x] 12.4 Integration test: Type filter workflow
    - Open type filter
