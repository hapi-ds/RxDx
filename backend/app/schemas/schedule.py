...
class ScheduleTaskBase(BaseModel):
    ...
    earliest_start: datetime | None = Field(None, description="Earliest possible start time")
...
class ScheduleResponse(BaseModel):
    ...
    project_duration_hours: int | None = Field(None, description="Total project duration in hours")
