...
async def demo_signature_service():
    ...
    print(f"   ✓ Generated 2048-bit RSA key pair")
    ...
    print(f"   ✓ RSA-PSS signature created")
    ...
    print(f"   ✓ New signature created for modified content")
    ...
    print(f"   Signatures: 2 created, both valid for their respective content")
    
    print(f"\nSecurity Properties:")
    print(f"   Content Hash: SHA-256 ({len(content_hash)} chars)")
    print(f"   Signature: RSA-PSS 2048-bit ({len(signature_hash)} chars)")
    print(f"   Integrity: Content changes invalidate signatures")
    print(f"   Authenticity: Wrong keys cannot verify signatures")
    print(f"   Non-repudiation: Each signature tied to specific user and content")
